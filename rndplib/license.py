...
def full_license_text():
    return "\n                                 Apache License\n              " \
           ...
           "its representatives, including but not limited to\n      " \
           ...
           "the NOTICE file are for informational purposes only and\n        " \
